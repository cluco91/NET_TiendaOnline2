    ...
    <table>
        ...
        <tr>
            ...
            <td style="margin-left: 10px">
                ...
                <asp:Button ID="btnAdd" runat="server" CssClass="button" OnClick="btnAdd_Click" Text="Agregar Producto" />
                <br />
        ...
        <tr>
            <td class="auto-style2">&nbsp;<asp:Label ID="lblAvailable" runat="server" CssClass="productPrice">Disponible!</asp:Label>
            </td>
        </tr>
    </table>
</asp:Content>
